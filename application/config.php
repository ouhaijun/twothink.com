...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'Z&F;afQ<C9=@c:w%DBG$1L7~yIsuKWeHgdn6.jkt', //默认数据加密KEY
	'data_cache_key'=> 'Z&F;afQ<C9=@c:w%DBG$1L7~yIsuKWeHgdn6.jkt',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'Z&F;afQ<C9=@c:w%DBG$1L7~yIsuKWeHgdn6.jkt', //加密KEY
